...
/**
 * CrmDocumentoAdjuntoContacto
 *
 * @ORM\Table(name="crm_documento_adjunto_contacto", indexes={@ORM\Index(name="fk_documento_adjunto_contacto_contacto", columns={"contacto"}), @ORM\Index(name="fk_documento_adjunto_contacto_usuario", columns={"usuario"})})
 * @ORM\Entity
 */
class CrmDocumentoAdjuntoContacto
{
    /**
     * @var integer
     *
