$(document).ready(function() {
	...
	$('#frmProvider').on('submit',(function(event) {
		...
		if (errores==0) {
			if (erroresEmail==0) {
				$.ajax({
					url: Routing.generate('admin_account_save_ajax'),
					type: "POST",
	...
	$(document).on('click', '#accountsList>tbody>tr>td:nth-child(2),#accountsList>tbody>tr>td:nth-child(3),#accountsList>tbody>tr>td:nth-child(4),#accountsList>tbody>tr>td:nth-child(5),#accountsList>tbody>tr>td:nth-child(6)', function(event) {
		/*/////Definición de variables*/
